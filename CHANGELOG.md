...
- Refactor `modifyOutput` function
- Update TypeScript target to ES2024
- Auto-fix files with ESLint (`eslint --fix`)
...
- Type `Geolocation.altitude` and `Geolocation.distance` correctly
...
- Make properties of `Result` optional
